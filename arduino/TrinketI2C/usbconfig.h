...
/*
This file has been modified for use as a part of TrinketI2C
 ...
 */
#define	USB_CFG_VENDOR_NAME		    'j','o','e','s','u','g','a','r','@','e','r','o','l','s','.','c','o','m'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'i', '2', 'c', ' ', 's', 't', 'i', 'c', 'k'
